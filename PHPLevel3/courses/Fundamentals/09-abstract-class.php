...
// Наброс чертёж
// Абcтрактные классы и методы
// Абстрактный клас это наброс чертёж будущего класса
// он может иметь абстрактные методы, но не обязательно, которые будущие классы должны реализовать
