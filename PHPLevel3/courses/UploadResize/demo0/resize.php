    ...
    if(is_array($_FILES)) {
        ...
        switch ($imageType) {
            ...
            case IMAGETYPE_PNG:
                ...
                $tmp = imageResize($imageSrc, $sourceProperties[], $sourceProperties[1]);
...
function imageResize($imageSrc,$imageWidth,$imageHeight) {
    ...
    imagecopyresampled($newImageLayer,$imageSrc,$newImageWidth,$newImageHeight,$imageWidth,$imageHeight);
